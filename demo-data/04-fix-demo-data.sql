...
SET definition = jsonb_set(
    definition,
    '{relatedArtifact}',
    '[{"type": "documentation", "label": "Reference Guideline", "display": "External clinical guideline", "url": "https://iris.who.int/server/api/core/bitstreams/0affb504-e80a-42db-9b53-7c442d4c72f2/content", "extension": [{"url": "http://openphc.org/fhir/thumbnail", "valueCode": "https://drive.google.com/file/d/1hr9FQjvpdvRIUpK2-tFhITMSOBQD0fq-/view?usp=sharing"}]}]'::jsonb
)
