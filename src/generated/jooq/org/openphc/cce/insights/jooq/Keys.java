...
public class Keys {
    ...
    public static final UniqueKey<Record> PK_FACILITY_REFERENCE = Internal.createUniqueKey(FacilityReference.FACILITY_REFERENCE, DSL.name("PK_facility_reference"), new TableField[] { FacilityReference.FACILITY_REFERENCE.ID }, true);
    ...
    public static final UniqueKey<Record> PK_MV_DAILY_DEVIATION_KPIS = Internal.createUniqueKey(MvDailyDeviationKpis.MV_DAILY_DEVIATION_KPIS, DSL.name("PK_mv_daily_deviation_kpis"), new TableField[] { MvDailyDeviationKpis.MV_DAILY_DEVIATION_KPIS.SNAPSHOT_DATE, MvDailyDeviationKpis.MV_DAILY_DEVIATION_KPIS.PROTOCOL_DEFINITION_ID }, true);
    public static final UniqueKey<Record> PK_MV_DAILY_EVENT_KPIS = Internal.createUniqueKey(MvDailyEventKpis.MV_DAILY_EVENT_KPIS, DSL.name("PK_mv_daily_event_kpis"), new TableField[] { MvDailyEventKpis.MV_DAILY_EVENT_KPIS.SNAPSHOT_DATE }, true);
    public static final UniqueKey<Record> PK_MV_DAILY_FACILITY_ACTIVITY_SUMMARY = Internal.createUniqueKey(MvDailyFacilityActivitySummary.MV_DAILY_FACILITY_ACTIVITY_SUMMARY, DSL.name("PK_mv_daily_facility_activity_summary"), new TableField[] { MvDailyFacilityActivitySummary.MV_DAILY_FACILITY_ACTIVITY_SUMMARY.SNAPSHOT_DATE }, true);
    public static final UniqueKey<Record> PK_MV_DAILY_FACILITY_KPIS = Internal.createUniqueKey(MvDailyFacilityKpis.MV_DAILY_FACILITY_KPIS, DSL.name("PK_mv_daily_facility_kpis"), new TableField[] { MvDailyFacilityKpis.MV_DAILY_FACILITY_KPIS.SNAPSHOT_DATE, MvDailyFacilityKpis.MV_DAILY_FACILITY_KPIS.FACILITY_ID }, true);
